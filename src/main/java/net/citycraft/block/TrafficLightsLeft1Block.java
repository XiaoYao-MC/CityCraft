...
public  class TrafficLightsLeft1Block extends BlockWithEntity implements BlockEntityProvider {
    ...
    public TrafficLightsLeft1Block(Settings settings){
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return checkType(type, TRAFFIC_LIGHTS_LEFT_1_ENTITY, (world1, pos, state1, be) -> TrafficLightsLeft1BlockEntity.tick(world1, pos, state1));
    }
}