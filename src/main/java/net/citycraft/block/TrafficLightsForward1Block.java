...
import static net.citycraft.CitycraftMod.TRAFFIC_LIGHTS_FORWARD_1_ENTITY;

public  class TrafficLightsForward1Block extends BlockWithEntity implements BlockEntityProvider {
    public static final IntProperty TRAFFIC_LIGHTS_COLOUR = IntProperty.of("traffic_lights_colour",0,3);
    public static final DirectionProperty FACING = Properties.HORIZONTAL_FACING;

    public TrafficLightsForward1Block(Settings settings){
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new TrafficLightsForward1BlockEntity(pos, state);
    }
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return checkType(type, TRAFFIC_LIGHTS_FORWARD_1_ENTITY, (world1, pos, state1, be) -> TrafficLightsForward1BlockEntity.tick(world1, pos, state1));
    }
}